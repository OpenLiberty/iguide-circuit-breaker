                        ...
                        if (currentStepIndex === 1) {
                           ...
                           setTimeout(function () {
                                ...
                                contentManager.setPodContentWithRightSlide(webBrowser.getStepName(),
                                    "<p class='maxspace'>The request is routed to the Check Balance microservice but the microservice is down. The circuit breaker has a policy to open the circuit after 1 failure, which comes from the requestVolumeThreshold value of 2 x the failureRatio of 0.5." +
