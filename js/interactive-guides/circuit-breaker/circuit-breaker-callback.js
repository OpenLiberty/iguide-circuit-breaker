                ...
                switch (stepName) {
                    ...
                    case 'ConfigureDelayParams':
                            ...
                            contentManager.setPodContentWithRightSlide(stepName,
                                "<div class='flexWithPic'>" +
                                "<div class='delayCountdownImgDiv'><div class='pod-animation-slide-from-left'><img src='/guides/iguide-circuit-breaker/html/interactive-guides/circuit-breaker/images/open.svg' alt='" + cbmessages.CHECK_BALANCE_OPEN + "' class='picInPod playgroundImg'></div></div>" +
